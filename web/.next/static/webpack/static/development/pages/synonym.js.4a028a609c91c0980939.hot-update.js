              ...
              case 6:
                ...
                if (response.status == 200) {
                  if (response.data.synonyms) {
                    alert(_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_1___default()(response.data.synonyms.map(function (word) {
                      return {
                        text: word
                      };
                    })));
...
//# sourceMappingURL=synonym.js.4a028a609c91c0980939.hot-update.js.map